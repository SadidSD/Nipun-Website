...
export default function ProjectNipun() {
  const nipunCity = projects.find(p => p.title === 'Nipun City')
  ...
  return (
    ...
    >
      ...
      <div className="relative top-[-20vh] z-20 flex flex-col items-center text-center px-4">
        <h2 className="text-4xl font-semibold font-josefin text-[#4E3B2C] ">NIPUN CITY</h2>
        <img
          src={image1}
          alt="Nipun City view"
      ...
      <motion.img
        ...
        src={image1}
        alt="Nipun City view"
        className="hidden lg:block w-[45vw] absolute left-[52.55vw] top-[75vh] rounded-[40px] object-contain"
      ...
      <div className="relative top-[-10vh] z-20 flex flex-col gap-[10vh] px-[5vw]">
        ...
        >
          <div className="w-[45vw] space-y-6">
            ...
            <div className="space-y-4 text-gray-700 text-[1vw] font-titillium">
              {[
                ['Project Name:', nipunCity.title],
                ['Location:', nipunCity.location],
                ['Land Area:', nipunCity.landArea],
                ['Height:', nipunCity.height],
                ['Total Flat:', nipunCity.totalFlat],
                ['Total Car Parking:', nipunCity.totalCarParking],
                ['Possible Handover Date:', nipunCity.type.replace('handover in ', '')],
        ...
        >
          <div className="w-full lg:w-[50%] space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 text-[1vw] font-titillium">
              {nipunCity.specialFeatures.map((feature, i) => (
                <li key={i}>{feature}</li>
              ))}
            </ul>
          </div>
        ...
        {/* Mobile Special Features (No animation) */}
