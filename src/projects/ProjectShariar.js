...
import image1 from '../images/project-shariar.jpg'
import image2 from '../images/image2.jpg'
import projects from '../pages/data'
import { motion, useScroll, useTransform } from "framer-motion"

export default function ProjectShariar() {
  const shariar = projects.find(p => p.title === 'Nipun Shariar Tower')
  ...
  return (
    ...
    >
      ...
      <div className="relative top-[-20vh] z-20 flex flex-col items-center text-center px-4">
        <h2 className="text-4xl font-semibold">NIPUN SHARIAR TOWER</h2>
        <img
          src={image1}
          alt="Shariar Tower"
      ...
      <div className="relative top-[-10vh] z-20 flex flex-col gap-[10vh] px-[5vw]">
        ...
        >
          <div className="w-[45vw] space-y-6">
            ...
            <div className="space-y-4 text-gray-700 text-[1vw]">
              {[ 
                ['Project Name:', shariar.title],
                ['Location:', shariar.location],
                ['Land Area:', shariar.landArea],
                ['Height:', shariar.height],
                ['Total Flat:', shariar.totalFlat],
                ['Total Car Parking:', shariar.totalCarParking],
                ['Possible Handover Date:', shariar.handover],
        ...
        <motion.div
          className="hidden lg:flex justify-end px-2 relative left-[-2vw] py-[15vh]"
        ...
        >
          <div className="w-full lg:w-[50%] space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 text-[1vw]">
              {shariar.specialFeatures.map((feature, i) => (
                <li key={i}>{feature}</li>
              ))}
            </ul>
          </div>
